(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Subject'), require('rxjs/operator/first'), require('rxjs/BehaviorSubject'), require('@angular/forms'), require('rxjs/operators/map'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Subject', 'rxjs/operator/first', 'rxjs/BehaviorSubject', '@angular/forms', 'rxjs/operators/map', '@angular/animations'], factory) :
	(factory((global.clr = global.clr || {}, global.clr.angular = {}),global.ng.core,global.ng.common,global.Rx,global.Rx.Observable.prototype,global.Rx,global.ng.forms,global.Rx.Observable.prototype,global.ng.animations));
}(this, (function (exports,core,common,Subject,first,BehaviorSubject,forms,map,animations) { 'use strict';
...
ClrSyntaxHighlightModule.decorators = [
    { type: core.NgModule, args: [{ imports: [common.CommonModule], declarations: [CLR_CODE_HIGHLIGHT_DIRECTIVES], exports: [CLR_CODE_HIGHLIGHT_DIRECTIVES] },] },
];
...
EmptyAnchor.ctorParameters = function () { return []; };
var ClrHostWrappingModule = (function () {
...
ClrHostWrappingModule.ctorParameters = function () { return []; };
var UP_ARROW = 38;
var DOWN_ARROW = 40;
var RIGHT_ARROW = 39;
var LEFT_ARROW = 37;
...
var DateNavigationService = (function () {
    function DateNavigationService() {
        ...
        this._selectedDayChange = new Subject.Subject();
        this._displayedCalendarChange = new Subject.Subject();
        this._focusOnCalendarChange = new Subject.Subject();
        this._focusedDayChange = new Subject.Subject();
    }
...
DateNavigationService.ctorParameters = function () { return []; };
var DatepickerFocusService = (function () {
    ...
    DatepickerFocusService.prototype.focusCell = function (elRef) {
        ...
        this._ngZone.runOutsideAngular(function () {
            first.first.call(_this._ngZone.onStable.asObservable()).subscribe(function () {
...
var LocaleHelperService = (function () {
    ...
    LocaleHelperService.prototype.initializeLocaleMonthsAbbreviated = function () {
        this._localeMonthsAbbreviated =
            common.getLocaleMonthNames(this.locale, common.FormStyle.Format, common.TranslationWidth.Abbreviated).slice();
    };
...
var FormControlService = (function () {
    function FormControlService() {
        ...
        this._idChange = new BehaviorSubject.BehaviorSubject(this._id);
    }
...
var DatepickerEnabledService = (function () {
...
var ClrDateContainer = (function () {
    function ClrDateContainer(_ifOpenService, _dateNavigationService, _datepickerEnabledService) {
        var _this = this;
...
var WrappedFormControl = (function () {
...
var ClrDateInput = (function (_super) {
    __extends(ClrDateInput, _super);
    function ClrDateInput(container, vcr, elRef, renderer, _ngControl, _dateIOService, _dateNavigationService, _datepickerEnabledService, platformId) {
            ...
            if (this._ngControl) {
                this._subscriptions.push(this._ngControl.valueChanges.subscribe(function (value) {
                    if (value) {
                        ...
                        if (date) {
                            _this._dateNavigationService.selectedDay =
...
var ViewManagerService = (function () {
...
ViewManagerService.ctorParameters = function () { return []; };
var ClrDatepickerViewManager = (function (_super) {
...
var ClrDay = (function () {
    function ClrDay(_dateNavigationService, _ifOpenService) {
        this._dateNavigationService = _dateNavigationService;
        this._ifOpenService = _ifOpenService;
    }
...
var ClrDatepickerModule = (function () {
...
ClrDatepickerModule.ctorParameters = function () { return []; };
var latestId = 0;
var ClrCheckboxDeprecated = (function () {
...
var ClrCheckboxModule = (function () {
...
ClrCheckboxModule.ctorParameters = function () { return []; };
...
var ClrDatagridFilter = (function (_super) {
...
var nbCount = 0;
var ClrDatagridColumn = (function (_super) {
...
var ClrDatagridPlaceholder = (function () {
...
var ClrSignpostTrigger = (function () {
...
var ColumnToggleButtonsService = (function () {
    function ColumnToggleButtonsService() {
        this.buttons = null;
        this.selectAllDisabled = false;
        this._okButtonClicked = new Subject.Subject();
        this._selectAllButtonClicked = new Subject.Subject();
    }
...
ColumnToggleButtonsService.ctorParameters = function () { return []; };
var StateProvider = (function () {
    function StateProvider(filters, sort, page, debouncer) {
        ...
        this.change = this.debouncer.change.pipe(map.map(function () { return _this.state; }));
    }
...
var ClrDatagridActionBar = (function () {
...
ClrDatagridActionBar.ctorParameters = function () { return []; };
var ClrDatagridActionOverflow = (function () {
...
var ClrDatagridColumnToggleButton = (function () {
...
var ClrDatagridColumnToggleTitle = (function () {
...
ClrDatagridColumnToggleTitle.ctorParameters = function () { return []; };
var ClrDatagridColumnToggle = (function () {
...
var ClrDatagridFooter = (function () {
...
var DatagridHideableColumnModel = (function () {
...
var ClrDatagridHideableColumn = (function () {
...
var ClrDatagridItemsTrackBy = (function () {
...
var ClrDatagridPagination = (function () {
...
var ClrDatagridRowDetail = (function () {
...
NoopDomAdapter.ctorParameters = function () { return []; };
...
DatagridMainRenderer.decorators = [
    { type: core.Directive, args: [{ selector: "clr-datagrid", providers: [{ provide: DomAdapter, useFactory: domAdapterFactory, deps: [core.PLATFORM_ID] }] },] },
];
...
ClrStackView.ctorParameters = function () { return []; };
ClrStackView.propDecorators = {
    "save": [{ type: core.Output, args: ["clrStackSave",] },],
};
var ClrStackHeader = (function () {
...
var ClrStackInput = (function (_super) {
...
var ClrStackSelect = (function (_super) {
...
var ClrStackViewCustomTags = (function () {
...
ClrStackViewCustomTags.ctorParameters = function () { return []; };
...
var ClrTreeNode = (function (_super) {
...
var ClrDropdownMenu = (function (_super) {
...
var ClrDropdownTrigger = (function () {
...
var ResponsiveNavCodes = (function () {
...
var ResponsiveNavControlMessage = (function () {
...
ClrMainContainerModule.decorators = [
    { type: core.NgModule, args: [{ imports: [common.CommonModule, ClrIconModule], declarations: [CLR_LAYOUT_DIRECTIVES], exports: [CLR_LAYOUT_DIRECTIVES] },] },
];
...
var ClrTabOverflowContent = (function (_super) {
...
var ClrVerticalNavGroup = (function () {
...
var ClrVerticalNavGroupChildren = (function () {
...
ClrVerticalNavGroupChildren.ctorParameters = function () { return []; };
var ClrVerticalNavIcon = (function () {
...
var ClrVerticalNavLink = (function () {
...
var ClrSignpostContent = (function (_super) {
...
ClrTooltip.ctorParameters = function () { return []; };
var POSITIONS$1 = ["bottom-left", "bottom-right", "top-left", "top-right", "right", "left"];
var SIZES = ["xs", "sm", "md", "lg"];
var ClrTooltipContent = (function (_super) {
...
var ClrTooltipTrigger = (function () {
...
var ClrWizardHeaderAction = (function () {
...
ClrWizardHeaderAction.ctorParameters = function () { return []; };
...
var ClrWizardPageButtons = (function () {
...
var ClrWizardPageHeaderActions = (function () {
...
var ClrWizardPageNavTitle = (function () {
...
var ClrWizardPageTitle = (function () {
...
var ClrWizardCustomTags = (function () {
...
ClrWizardCustomTags.ctorParameters = function () { return []; };
var ClrWizardStepnav = (function () {
...
var ClrWizardStepnavItem = (function () {
...
ClrLabel.ctorParameters = function () { return [
    { type: FormControlService, decorators: [{ type: core.Optional },] },
]; };
ClrLabel.propDecorators = {
    "forAttr": [{ type: core.HostBinding, args: ["attr.for",] }, { type: core.Input, args: ["for",] },],
};
var ClrCommonFormsModule = (function () {
    function ClrCommonFormsModule() {
    }
    return ClrCommonFormsModule;
}());
ClrCommonFormsModule.decorators = [
    { type: core.NgModule, args: [{ imports: [common.CommonModule], declarations: [ClrLabel], exports: [ClrLabel] },] },
];
ClrCommonFormsModule.ctorParameters = function () { return []; };
var ClrCheckboxContainer = (function () {
...
var ClrCheckboxNext = (function (_super) {
...
var ClrCheckboxNextModule = (function () {
...
ClrCheckboxNextModule.ctorParameters = function () { return []; };
var ClrRadioContainer = (function () {
...
ClrRadioModule.ctorParameters = function () { return []; };
var ClrFormsNextModule = (function () {
...
ClrFormsNextModule.ctorParameters = function () { return []; };
function collapse() {
    return [
...
exports.ɵcs = DatagridRowExpandAnimation;
exports.ɵcp = ActionableOompaLoompa;
exports.ɵcn = DatagridWillyWonka;
exports.ɵcr = ExpandableOompaLoompa;
exports.ɵca = ClrDatagridColumnToggleButton;
exports.ɵbz = ClrDatagridColumnToggleTitle;
exports.ɵcc = DatagridDetailRegisterer;
exports.ɵcb = ClrDatagridItemsTrackBy;
exports.ɵbu = ColumnToggleButtonsService;
exports.ɵbx = CustomFilter;
exports.ɵbw = DragDispatcher;
exports.ɵbl = FiltersProvider;
exports.ɵbr = ExpandableRowsCount;
exports.ɵbs = HideableColumnService;
exports.ɵbk = Items;
exports.ɵbm = Page;
exports.ɵbq = RowActionService;
exports.ɵbj = Selection;
exports.ɵbo = Sort;
exports.ɵbn = StateDebouncer;
exports.ɵbt = StateProvider;
exports.ɵck = DatagridBodyRenderer;
exports.ɵcm = DatagridCellRenderer;
exports.ɵch = DatagridColumnResizer;
exports.ɵcf = DomAdapter;
exports.ɵcj = DatagridHeadRenderer;
exports.ɵcg = DatagridHeaderRenderer;
exports.ɵce = DatagridMainRenderer;
exports.ɵcd = domAdapterFactory;
exports.ɵbp = DatagridRenderOrganizer;
exports.ɵcl = DatagridRowRenderer;
exports.ɵci = DatagridTableRenderer;
exports.ɵbv = DatagridFilterRegistrar;
exports.ɵcw = StackControl;
exports.ɵcx = AbstractTreeSelection;
exports.ɵcz = clrTreeSelectionProviderFactory;
exports.ɵcy = TreeSelectionService;
exports.ɵr = AlertIconAndTypesService;
exports.ɵs = MultiAlertService;
exports.ɵz = FormControlService;
exports.ɵbd = WrappedFormControl;
exports.ɵbb = DateIOService;
exports.ɵy = DateNavigationService;
exports.ɵbc = DatepickerEnabledService;
exports.ɵbf = DatepickerFocusService;
exports.ɵba = LocaleHelperService;
exports.ɵbe = ViewManagerService;
...
exports.ɵde = GHOST_PAGE_ANIMATION;
...
exports.ɵcq = OompaLoompa;
exports.ɵco = WillyWonka;
...
exports.ɵct = ClrIfExpandModule;
exports.ɵcv = IfExpanded;
exports.ɵcu = EXPAND_DIRECTIVES;
exports.ɵby = Expand;
...
exports.ɵda = UNIQUE_ID;
exports.ɵdc = UNIQUE_ID_PROVIDER;
exports.ɵdb = uniqueIdFactory;
exports.ɵbh = OUSTIDE_CLICK_DIRECTIVES;
exports.ɵbi = OutsideClick;
exports.ɵbg = ClrOutsideClickModule;
exports.ɵdd = ScrollingService;
