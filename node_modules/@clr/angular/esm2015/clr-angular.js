...
/** @nocollapse */
ClrHostWrappingModule.ctorParameters = () => [];
...
/** @nocollapse */
DateNavigationService.ctorParameters = () => [];
...
class ClrDateContainer {
     ...
     */
    constructor(_ifOpenService, _dateNavigationService, _datepickerEnabledService) {
...
class ClrDateInput extends WrappedFormControl {
     ...
     * @param {?} platformId
     */
    constructor(container, vcr, elRef, renderer, _ngControl, _dateIOService, _dateNavigationService, _datepickerEnabledService, platformId) {
    ...
    initializeSubscriptions() {
        if (this._dateNavigationService && this._dateIOService) {
            ...
            this._subscriptions.push(this._dateNavigationService.selectedDayChange.subscribe((dayModel) => {
                const /** @type {?} */ date = dayModel.toDate();
...
/** @nocollapse */
ViewManagerService.ctorParameters = () => [];
...
class ClrDay {
     ...
     * @param {?} _ifOpenService
     */
    constructor(_dateNavigationService, _ifOpenService) {
        this._dateNavigationService = _dateNavigationService;
        this._ifOpenService = _ifOpenService;
    }
    /**
...
/** @nocollapse */
ClrCheckboxDeprecated.ctorParameters = () => [];
...
/** @nocollapse */
ColumnToggleButtonsService.ctorParameters = () => [];
        ...
        if (activeFilters.length > 0) {
            ...
            for (const /** @type {?} */ filter of activeFilters) {
                if (filter instanceof DatagridStringFilterImpl) {
                    const /** @type {?} */ stringFilter = (/** @type {?} */ (filter)).filterFn;
...
/** @nocollapse */
ClrDatagridActionBar.ctorParameters = () => [];
...
/** @nocollapse */
ClrDatagridColumnToggleTitle.ctorParameters = () => [];
...
// The only purpose is to "declare" the tag in Angular
/** @nocollapse */
ClrStackViewCustomTags.ctorParameters = () => [];
...
/** @nocollapse */
ClrVerticalNavGroupChildren.ctorParameters = () => [];
...
/** @nocollapse */
ClrWizardHeaderAction.ctorParameters = () => [];
...
// The only purpose is to "declare" the tag in Angular
/** @nocollapse */
ClrWizardCustomTags.ctorParameters = () => [];
...
/** @nocollapse */
ClrCheckboxNextModule.ctorParameters = () => [];
...
/** @nocollapse */
ClrFormsNextModule.ctorParameters = () => [];
