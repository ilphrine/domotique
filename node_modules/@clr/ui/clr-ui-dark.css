 ...
 *
 * Clarity v0.11.14 | MIT license | https://github.com/vmware/clarity
 *
 */
 ...
 *
 * Usage:
 * - ../forms-deprecated/_forms.clarity.scss
 * - ../forms-deprecated/_select.clarity.scss
 * - ../forms-deprecated/_radio.clarity.scss
 * - ../forms-deprecated/_checkboxes.clarity.scss
...
.btn clr-icon {
  transform: translate3d(0rem, -0.08333rem, 0); }
...
.btn-primary .btn {
  ...
  .btn-primary .btn:active {
    box-shadow: 0 1px 0 0 #0065ab inset; }
...
.btn-inverse .btn, .alert-app-level .alert-item .btn .btn {
  border-color: #000;
  background-color: transparent;
  color: #000; }
  .btn.btn-inverse:visited, .alert-app-level .alert-item .btn:visited,
  .btn-inverse .btn:visited, .alert-app-level .alert-item .btn .btn:visited {
    color: #000; }
  .btn.btn-inverse:hover, .alert-app-level .alert-item .btn:hover,
  .btn-inverse .btn:hover, .alert-app-level .alert-item .btn .btn:hover {
    background-color: rgba(0, 0, 0, 0.1);
    color: #000; }
  .btn.btn-inverse:active, .alert-app-level .alert-item .btn:active,
  .btn-inverse .btn:active, .alert-app-level .alert-item .btn .btn:active {
    box-shadow: 0 1px 0 0 #a9b6be inset; }
  ...
  .btn-inverse .btn.disabled, .alert-app-level .alert-item .btn .btn.disabled,
  .btn-inverse .btn:disabled, .alert-app-level .alert-item .btn .btn:disabled {
    color: #fff;
    cursor: not-allowed;
    background-color: transparent;
...
.btn-sm:not(.btn-link) clr-icon, .alert-app-level .alert-item .btn:not(.btn-link) clr-icon {
  width: 0.5rem;
  height: 0.5rem;
  transform: translate3d(0rem, -0.04167rem, 0); }
...
.btn-group.btn-danger .dropdown-toggle {
  ...
  .btn-group.btn-danger .dropdown-toggle:active {
    box-shadow: 0 1px 0 0 #0065ab inset; }
  .btn-group.btn-primary .dropdown-toggle.disabled, .btn-group.btn-primary .dropdown-toggle:disabled,
...
.checkbox.btn.btn-success-outline input[type="checkbox"]:checked + label, .checkbox.btn.btn-outline-success input[type="checkbox"]:checked + label,
...
.checkbox.btn.btn-danger-outline input[type="checkbox"]:checked + label, .checkbox.btn.btn-outline-danger input[type="checkbox"]:checked + label, .checkbox.btn.btn-warning-outline input[type="checkbox"]:checked + label, .checkbox.btn.btn-outline-warning input[type="checkbox"]:checked + label,
...
.checkbox-inline.btn.btn-inverse input[type="checkbox"]:checked + label, .alert-app-level .alert-item .checkbox-inline.btn input[type="checkbox"]:checked + label {
...
.card-footer .checkbox.btn label, .card-footer .checkbox-inline.btn label, .card-footer .radio.btn label, .card-footer .radio-inline.btn label {
  line-height: calc(1rem - 1px); }
...
.toggle-switch {
  ...
  .toggle-switch input[type="checkbox"]:checked:disabled + label::after {
    ...
    height: 0.5833rem;
    top: 5px; }
  .toggle-switch.right-label label {
    margin-left: 1.75rem;
    margin-right: 0; }
  .toggle-switch.right-label input[type="checkbox"] + label::before {
    right: 0;
    left: -1.75rem; }
  .toggle-switch.right-label input[type="checkbox"] + label::after {
    right: 0;
    left: -1.66667rem;
    transition-property: left; }
  .toggle-switch.right-label input[type="checkbox"]:checked + label::after {
    left: -1.04167rem;
    transition-property: left; }
...
.alert-sm {
  ...
  .alert-sm .alert-items {
    padding: calc(0.16667rem - 1px) calc(0.25rem - 1px); }
  .alert-sm .alert-item {
    padding-top: 0.04167rem;
  ...
  .alert-sm .close {
    ...
    .alert-sm .close clr-icon {
      ...
      height: 0.83333rem;
      width: 0.83333rem;
      line-height: calc(0.83333rem + 1px); }
...
.card .list,
.card .list-unstyled, .card-block .card-divider {
  margin-top: 0;
  margin-bottom: 0.5rem; }
  ...
  .card .list-unstyled:last-child, .card-block .card-divider:last-child {
    margin-bottom: 0; }

.card-img > img, .card.card-img > img,
...
.card {
  ...
  .card .list-group-item {
    font-size: clr-getTypePropertyValueForDomElement(card_text, font-size);
    border-left-width: 0;
...
.dropdown-menu .dropdown-header, .dropdown-menu .btn,
  ...
  .dropdown-menu .dropdown-item {
    ...
    .dropdown-menu .dropdown-item.expandable {
      ...
      .dropdown-menu .dropdown-item.expandable:before {
        ...
        height: 0.5rem;
        width: 0.5rem;
        transform: rotate(-90deg) translateX(-0.333rem);
    ...
    .dropdown-menu .dropdown-item:disabled {
      ...
      .dropdown-menu .dropdown-item:disabled:hover {
        background: none; }
      .dropdown-menu .btn.disabled:active, .dropdown-menu .btn.disabled:focus, .dropdown-menu .btn:disabled:active, .dropdown-menu .btn:disabled:focus,
...
.label, a.label {
  ...
  .label.clickable.label-blue:active, a.label.clickable.label-blue:active {
    box-shadow: 0 1px 0 0 #007cbb inset;
    transform: translateY(0.5px); }
...
ul, ol {
  ...
  ul.list, ol.list {
    ...
    ul.list.compact, ol.list.compact {
      line-height: 0.75rem; }
      ul.list.compact > li, ol.list.compact > li {
        margin-bottom: 0.25rem; }
        ul.list.compact > li:last-child, ol.list.compact > li:last-child {
          margin-bottom: 0; }

ul:not(.list-unstyled) > li > ul.list-unstyled, ol > li > ul.list-unstyled {
  margin-left: 1.1em; }
...
.login-wrapper {
  ...
  .login-wrapper .login {
    ...
    .login-wrapper .login .login-group {
      ...
      flex-direction: column;
      padding: 2rem 0 0 0; }
      .login-wrapper .login .login-group .auth-source, .login-wrapper .login .login-group .username, .login-wrapper .login .login-group .password, .login-wrapper .login .login-group .checkbox {
...
.header {
  ...
  .header .header-nav {
    ...
    .header .header-nav .nav-link {
      ...
      header .header-nav .nav-link .nav-text, header .header-nav .nav-link.nav-icon, header .header-nav .nav-link.nav-text,
      .header .header-nav .nav-link .fa,
      .header .header-nav .nav-link .nav-icon,
      ...
      .header .header-nav .nav-link.active {
        ...
        opacity: 1; }
      header .header-nav .nav-link.active.nav-icon, header .header-nav .nav-link.active.nav-text,
  ...
  .header .header-actions {
    ...
    .header .header-actions .nav-link {
      ...
      header .settings .nav-link .nav-text, header .settings .nav-link.nav-icon, header .settings .nav-link.nav-text,
      ...
      .header .header-actions .nav-link.active {
        background: rgba(255, 255, 255, 0.15);
        opacity: 1; }
      header .settings .nav-link.active.nav-icon, header .settings .nav-link.active.nav-text,
...
.sidenav {
  ...
  .sidenav .nav-group {
    ...
    .sidenav .nav-group .nav-list {
      ...
      .sidenav .nav-group .nav-list .nav-link {
        ...
        padding: 0.16667rem 0 0.16667rem 0.5rem; }
  ...
  .sidenav .collapsible label {
    ...
    .sidenav .collapsible label:after {
      ...
      height: 0.41667rem;
      width: 0.41667rem;
      transform: translateX(-0.33333rem) translateY(0.29167rem);
      background-image: url("data:image/svg+xml;charset=utf8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2012%2012%22%3E%0A%20%20%20%20%3Cdefs%3E%0A%20%20%20%20%20%20%20%20%3Cstyle%3E.cls-1%7Bfill%3A%239a9a9a%3B%7D%3C%2Fstyle%3E%0A%20%20%20%20%3C%2Fdefs%3E%0A%20%20%20%20%3Ctitle%3ECaret%3C%2Ftitle%3E%0A%20%20%20%20%3Cpath%20class%3D%22cls-1%22%20d%3D%22M6%2C9L1.2%2C4.2a0.68%2C0.68%2C0%2C0%2C1%2C1-1L6%2C7.08%2C9.84%2C3.24a0.68%2C0.68%2C0%2C1%2C1%2C1%2C1Z%22%2F%3E%0A%3C%2Fsvg%3E%0A");
      background-repeat: no-repeat;
      background-size: contain;
      vertical-align: middle;
      margin: 0; }
  .sidenav .collapsible .nav-list, .sidenav .collapsible ul {
    overflow: hidden; }
  ...
  .sidenav .collapsible input[type="checkbox"]:checked ~ label:after {
    transform: rotate(-90deg) translateX(-0.29167rem) translateY(-0.33333rem); }
...
.clr-vertical-nav {
  ...
  .clr-vertical-nav .nav-group-content {
    display: flex;
    color: #adbbc4; }
    .clr-vertical-nav .nav-group-content:hover, .clr-vertical-nav .nav-group-content.active {
      color: #fff;
      background-color: #324f61; }
      .clr-vertical-nav .nav-group-content:hover .nav-icon, .clr-vertical-nav .nav-group-content.active .nav-icon {
        fill: #fff; }
  ...
  .clr-vertical-nav .nav-link {
    display: flex;
    color: #adbbc4; }
    .clr-vertical-nav .nav-link:hover, .clr-vertical-nav .nav-link.active {
      color: #fff;
      background-color: #324f61; }
      .clr-vertical-nav .nav-link:hover .nav-icon, .clr-vertical-nav .nav-link.active .nav-icon {
        fill: #fff; }
...
@media screen and (max-width: 768px) {
  ...
  .main-container .sub-nav.clr-nav-level-2 .nav {
    ...
    .main-container .sub-nav.clr-nav-level-2 .nav .nav-link {
      ...
      .main-container .sub-nav.clr-nav-level-2 .nav .nav-link.active {
        color: #fff;
        background-color: #324f61; }
        .main-container .subnav.clr-nav-level-1 .nav .nav-link:hover .nav-icon, .main-container .subnav.clr-nav-level-1 .nav .nav-link.active .nav-icon,
        .main-container .sub-nav.clr-nav-level-1 .nav .nav-link:hover .nav-icon,
        .main-container .sub-nav.clr-nav-level-1 .nav .nav-link.active .nav-icon,
        .main-container .subnav.clr-nav-level-2 .nav .nav-link:hover .nav-icon,
        .main-container .subnav.clr-nav-level-2 .nav .nav-link.active .nav-icon,
        .main-container .sub-nav.clr-nav-level-2 .nav .nav-link:hover .nav-icon,
  ...
  .main-container.open-overflow-menu .header .header-nav.clr-nav-level-2 .nav-link {
    ...
    .main-container.open-overflow-menu .header .header-nav.clr-nav-level-2 .nav-link .nav-icon + .nav-text {
      display: inline-block; }
    .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-1 .nav-link:hover, .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-1 .nav-link.active,
    .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-2 .nav-link:hover,
    .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-2 .nav-link.active, .main-container.open-overflow-menu .header .header-nav.clr-nav-level-1 .nav-link:hover, .main-container.open-overflow-menu .header .header-nav.clr-nav-level-1 .nav-link.active,
    ...
    .main-container.open-overflow-menu .header .header-nav.clr-nav-level-2 .nav-link.active {
      color: #fff;
      background-color: #324f61; }
      .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-1 .nav-link:hover .nav-icon, .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-1 .nav-link.active .nav-icon,
      .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-2 .nav-link:hover .nav-icon,
      .main-container.open-hamburger-menu .header .header-nav.clr-nav-level-2 .nav-link.active .nav-icon, .main-container.open-overflow-menu .header .header-nav.clr-nav-level-1 .nav-link:hover .nav-icon, .main-container.open-overflow-menu .header .header-nav.clr-nav-level-1 .nav-link.active .nav-icon,
      .main-container.open-overflow-menu .header .header-nav.clr-nav-level-2 .nav-link:hover .nav-icon,
...
.progress.flash > progress, .progress.flash-danger > progress {
  transition: color 0.1s ease-out 1s; }
  .progress.flash > progress::-webkit-progress-value, .progress.flash-danger > progress::-webkit-progress-value {
    transition: width 0.23s ease-in, background-color 0.1s ease-out 0.3s; }
  .progress.flash > progress[value="0"]::-webkit-progress-value, .progress.flash-danger > progress[value="0"]::-webkit-progress-value {
    transition: none; }
  .progress.flash > progress::-moz-progress-bar, .progress.flash-danger > progress::-moz-progress-bar {
    transition: width 0.23s ease-in, background-color 0.1s ease-out 0.3s; }
...
.card-block .progress, .card-block .progress-static,
...
.card-block .progress > progress, .card-block .progress-static > .progress-meter,
.card-footer .progress > progress,
.card-footer .progress-static > .progress-meter {
  height: 0.15625rem;
  position: absolute; }

.card-block .progress.top, .card-block .progress-static.top,
...
.tooltip {
  ...
  .tooltip:focus > :first-child {
    outline-offset: 0.04167rem;
    outline-width: 0.04167rem;
  ...
  .tooltip.tooltip-top-right > .tooltip-content, .tooltip .tooltip-content.tooltip-top-right {
    ...
    .tooltip.tooltip-top-right > .tooltip-content::before, .tooltip .tooltip-content.tooltip-top-right::before {
      position: absolute;
      bottom: -0.375rem;
      left: 0;
      top: auto;
      ...
      border-top: 0.20833rem solid #fff;
  ...
  .tooltip.tooltip-bottom-right > .tooltip-content, .tooltip .tooltip-content.tooltip-bottom-right {
    ...
    .tooltip.tooltip-bottom-right > .tooltip-content::before, .tooltip .tooltip-content.tooltip-bottom-right::before {
      ...
      content: '';
      border-left: 0.25rem solid #fff;
      border-bottom: 0.20833rem solid #fff;
      border-right: 0.25rem solid transparent;
  ...
  .tooltip.tooltip-right > .tooltip-content, .tooltip .tooltip-content.tooltip-right {
    ...
    .tooltip.tooltip-right > .tooltip-content::before, .tooltip .tooltip-content.tooltip-right::before {
      ...
      border-left: 0.20833rem solid transparent; }
  .tooltip.tooltip-left > .tooltip-content, .tooltip .tooltip-content.tooltip-left {
    ...
    .tooltip.tooltip-left > .tooltip-content::before, .tooltip .tooltip-content.tooltip-left::before {
      ...
      border-bottom: 0.25rem solid transparent;
      border-right: 0.20833rem solid transparent; }
...
input[type=text], input[type=password], input[type=number], input[type=email], input[type=url], input[type=tel], input[type=date], input[type=time], input[type=datetime-local] {
  -webkit-appearance: none;
  -moz-appearance: none;
  -ms-appearance: none;
  -o-appearance: none;
  ...
  padding: 0 0.25rem; }
  input[type=text]:focus, input[type=password]:focus, input[type=number]:focus, input[type=email]:focus, input[type=url]:focus, input[type=tel]:focus, input[type=date]:focus, input[type=time]:focus, input[type=datetime-local]:focus {
    outline: 0; }
  input[type=text]:not([readonly]), input[type=password]:not([readonly]), input[type=number]:not([readonly]), input[type=email]:not([readonly]), input[type=url]:not([readonly]), input[type=tel]:not([readonly]), input[type=date]:not([readonly]), input[type=time]:not([readonly]), input[type=datetime-local]:not([readonly]) {
    ...
    input[type=text]:not([readonly]):focus, input[type=password]:not([readonly]):focus, input[type=number]:not([readonly]):focus, input[type=email]:not([readonly]):focus, input[type=url]:not([readonly]):focus, input[type=tel]:not([readonly]):focus, input[type=date]:not([readonly]):focus, input[type=time]:not([readonly]):focus, input[type=datetime-local]:not([readonly]):focus {
      border-bottom: 1px solid #0094d2;
      background-size: 100% 100%; }
  input[type=text][readonly], input[type=password][readonly], input[type=number][readonly], input[type=email][readonly], input[type=url][readonly], input[type=tel][readonly], input[type=date][readonly], input[type=time][readonly], input[type=datetime-local][readonly] {
    border: none; }

input[type=text]:disabled, input[type=password]:disabled, input[type=number]:disabled, input[type=email]:disabled, input[type=url]:disabled, input[type=tel]:disabled, input[type=date]:disabled, input[type=time]:disabled, input[type=datetime-local]:disabled,
...
.checkbox-inline {
  ...
  .checkbox-inline.disabled input[type="checkbox"]:checked + label::after {
    border-left: 0.08333rem solid #22343c;
    border-bottom: 0.08333rem solid #22343c; }
...
.radio-inline {
  ...
  .radio-inline input[type="radio"]:focus:checked + label::before {
    outline: 0;
    box-shadow: inset 0 0 0 0.25rem #49afd9, 0 0 2px 2px #49afd9; }
  ...
  .radio-inline.disabled input[type="radio"]:checked + label::before {
    background-color: #22343c;
    box-shadow: inset 0 0 0 0.25rem #8f9ba3; }
...
.form {
  ...
  .form .form-group {
    ...
    form .form-group > input[type=text], form .form-group input[type=password], form .form-group input[type=number], form .form-group input[type=email], form .form-group input[type=url], form .form-group input[type=tel], form .form-group input[type=date], form .form-group input[type=time], form .form-group input[type=datetime-local],
    ...
    form .form-group > a,
    form .form-group > input[type=button], form .form-group input[type=submit],
    form .form-group > .btn,
    .form .form-group > label:not(:first-child),
    .form .form-group > span:not(:first-child),
    ...
    .form .form-group .btn {
      margin-top: 0.25rem;
      margin-bottom: 0.25rem; }
    form .form-group .btn-sm, form .form-group .alert-app-level .alert-item .btn, .alert-app-level .alert-item form .form-group .btn,
    .form .form-group .btn-sm,
    .form .form-group .alert-app-level .alert-item .btn, .alert-app-level .alert-item
    .form .form-group .btn {
      margin-top: 0.5rem;
      margin-bottom: 0.5rem; }
    form .form-group .tooltip-validation,
...
.tooltip.tooltip-validation.invalid > input {
  ...
  background: linear-gradient(to bottom, transparent 95%, #f54f47 95%);
  transition: none; }
...
.tooltip.tooltip-validation.invalid > .tooltip-content::before, .tooltip.tooltip-validation.invalid.tooltip-top-right > .tooltip-content::before {
  border-left-color: #f54f47;
  border-top-color: #f54f47;
  border-right-color: transparent;
  border-bottom-color: transparent; }

.tooltip.tooltip-validation.invalid.tooltip-top-left > .tooltip-content::before {
  border-right-color: #f54f47;
  border-top-color: #f54f47;
...
_:-ms-input-placeholder input[type=text], _:-ms-input-placeholder input[type=password], _:-ms-input-placeholder input[type=number], _:-ms-input-placeholder input[type=email], _:-ms-input-placeholder input[type=url], _:-ms-input-placeholder input[type=tel], _:-ms-input-placeholder input[type=date], _:-ms-input-placeholder input[type=time], _:-ms-input-placeholder input[type=datetime-local], :root input[type=text], :root input[type=password], :root input[type=number], :root input[type=email], :root input[type=url], :root input[type=tel], :root input[type=date], :root input[type=time], :root input[type=datetime-local] {
...
.stack-header {
  font-weight: clr-getTypePropertyValueForDomElement(stackview_text, font-weight);
  display: flex;
  align-items: flex-end; }
...
.stack-view {
  ...
  .stack-view .stack-block-changed::before {
    ...
    width: 0;
    height: 0;
    border-top: 0.375rem solid #006a91;
    border-right: 0.375rem solid transparent; }
  .stack-view .stack-block-label, .stack-view .stack-block-content {
    padding: 0.25rem 0.5rem;
    background-color: #1b2a32; }
  ...
  .stack-view .stack-block-expandable:hover:not(.stack-block-expanded) > .stack-block-label, .stack-view .stack-block-expandable:hover:not(.stack-block-expanded) > .stack-block-content {
    background-color: #324f61; }
  .stack-view .stack-block-expanded > .stack-block-label::before {
    transform: rotate(0deg); }
  .stack-view .stack-block-expanded > .stack-block-label, .stack-view .stack-block-expanded > .stack-block-content {
    background-color: #324f61;
    color: #fff; }
...
.clr-treenode-checkbox {
  ...
  .clr-treenode-checkbox:first-child {
    margin-left: 1.25rem; }
...
.datagrid {
  ...
  max-width: 100%;
  width: 100%; }
  .datagrid .datagrid-column, .datagrid .datagrid-head .datagrid-row-actions,
  .datagrid .datagrid-cell {
    ...
    text-align: center;
    vertical-align: top; }
    .datagrid .datagrid-column.left, .datagrid .datagrid-head .left.datagrid-row-actions,
    .datagrid .datagrid-cell.left {
      text-align: left; }
      .datagrid .datagrid-column.left:first-child, .datagrid .datagrid-head .left.datagrid-row-actions:first-child,
  ...
  .datagrid .datagrid-body + .datagrid-body {
    border-top: 1px solid #485764; }
  .datagrid .datagrid-head .datagrid-column:first-child, .datagrid .datagrid-head .datagrid-row-actions:first-child {
    border-radius: calc(0.125rem - 1px) 0 0 0; }
  .datagrid .datagrid-head .datagrid-column:last-child, .datagrid .datagrid-head .datagrid-row-actions:last-child {
    border-radius: 0 calc(0.125rem - 1px) 0 0; }
...
.datagrid-compact .datagrid-column, .datagrid-compact .datagrid .datagrid-head .datagrid-row-actions, .datagrid .datagrid-head .datagrid-compact .datagrid-row-actions, .datagrid-compact .datagrid-cell {
  padding-top: calc(0.20833rem + 1px);
  padding-bottom: calc(0.20833rem); }
...
.datagrid-head, .datagrid-body, .datagrid-row, .datagrid-column, .datagrid .datagrid-head .datagrid-row-actions, .datagrid-cell, .datagrid-fixed-column {
  display: block; }
...
.datagrid-column, .datagrid .datagrid-head .datagrid-row-actions {
  display: flex;
  flex: 1 1 auto; }
  .datagrid-column.datagrid-fixed-width, .datagrid .datagrid-head .datagrid-fixed-width.datagrid-row-actions {
    flex: 0 0 auto; }
...
.datagrid-no-layout {
  display: block; }
  .datagrid-no-layout .datagrid-body, .datagrid-no-layout .datagrid-row, .datagrid-no-layout .datagrid-cell {
    display: none; }
  .datagrid-no-layout .datagrid-head, .datagrid-no-layout .datagrid-head .datagrid-row, .datagrid-no-layout .datagrid-column, .datagrid-no-layout .datagrid .datagrid-head .datagrid-row-actions, .datagrid .datagrid-head .datagrid-no-layout .datagrid-row-actions {
    display: block; }
...
.datagrid-computing-columns-width {
  ...
  .datagrid-computing-columns-width .datagrid-head .datagrid-row {
    display: table-row; }
  .datagrid-computing-columns-width .datagrid-row-master {
    display: table-row; }
  .datagrid-computing-columns-width .datagrid-row-detail {
    display: none; }
  .datagrid-computing-columns-width .datagrid-column, .datagrid-computing-columns-width .datagrid .datagrid-head .datagrid-row-actions, .datagrid .datagrid-head .datagrid-computing-columns-width .datagrid-row-actions, .datagrid-computing-columns-width .datagrid-cell {
    display: table-cell; }
  ...
  .datagrid-computing-columns-width .datagrid-placeholder-container {
    display: none; }
  .datagrid-computing-columns-width .datagrid-fixed-column {
    display: none; }
...
.datagrid {
  ...
  .datagrid .datagrid-body .datagrid-row:last-child .datagrid-cell:last-child {
    border-radius: 0; }
  .datagrid .datagrid-column, .datagrid .datagrid-head .datagrid-row-actions, .datagrid .datagrid-cell {
    text-align: left;
    min-width: 4rem; }
    .datagrid .datagrid-column.datagrid-fixed-column, .datagrid .datagrid-head .datagrid-fixed-column.datagrid-row-actions, .datagrid .datagrid-cell.datagrid-fixed-column {
      flex: 0 0 1.58333rem;
      max-width: 1.58333rem;
      min-width: 1.58333rem; }
  ...
  .datagrid .datagrid-column, .datagrid .datagrid-head .datagrid-row-actions {
    ...
    background: none;
    border-bottom: 0; }
    .datagrid .datagrid-column .datagrid-column-title, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-title {
      -webkit-appearance: none;
      -moz-appearance: none;
      -ms-appearance: none;
      -o-appearance: none;
      ...
      flex: 1 1 auto;
      align-self: flex-start; }
    .datagrid .datagrid-column button.datagrid-column-title:hover, .datagrid .datagrid-head .datagrid-row-actions button.datagrid-column-title:hover {
      text-decoration: underline;
      cursor: pointer; }
    .datagrid .datagrid-column .datagrid-column-separator, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator {
      position: relative;
      left: 0.5rem;
      flex: 0 0 auto;
      width: 1px;
      order: 100;
      margin-left: auto; }
      .datagrid .datagrid-column .datagrid-column-separator::after, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator::after {
        content: "";
        position: absolute;
        height: calc(100% + 0.5rem - 1px);
        width: 0.04167rem;
        top: calc(-0.5 * 0.5rem + 1px);
        left: 0;
        background-color: #485764; }
      .datagrid .datagrid-column .datagrid-column-separator .datagrid-column-handle, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator .datagrid-column-handle {
        -webkit-appearance: none;
        -moz-appearance: none;
        -ms-appearance: none;
        -o-appearance: none;
        ...
        height: calc(100% + 0.5rem - 1px);
        z-index: 1000; }
      .datagrid .datagrid-column .datagrid-column-separator .datagrid-column-handle-tracker, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator .datagrid-column-handle-tracker {
        position: absolute;
        right: 0;
        top: -0.5rem;
        display: none;
      ...
      .datagrid .datagrid-column .datagrid-column-separator .exceeded-max, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator .exceeded-max {
        border-right: 1px dotted rgba(230, 39, 0, 0.3); }
    .datagrid .datagrid-column:last-child .datagrid-column-separator, .datagrid .datagrid-head .datagrid-row-actions:last-child .datagrid-column-separator {
      display: none; }
    .datagrid .datagrid-column .datagrid-column-flex, .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-flex {
      display: flex;
      flex: 1 1 auto; }
    .datagrid .datagrid-column clr-dg-filter, .datagrid .datagrid-head .datagrid-row-actions clr-dg-filter,
    .datagrid .datagrid-column clr-dg-string-filter, .datagrid .datagrid-head .datagrid-row-actions clr-dg-string-filter {
      display: flex;
      order: 99;
      margin-left: auto; }
    .datagrid .datagrid-column.asc, .datagrid .datagrid-head .asc.datagrid-row-actions, .datagrid .datagrid-column.desc, .datagrid .datagrid-head .desc.datagrid-row-actions {
      font-weight: 600; }
      .datagrid .datagrid-column.asc .datagrid-column-flex::after, .datagrid .datagrid-head .asc.datagrid-row-actions .datagrid-column-flex::after, .datagrid .datagrid-column.desc .datagrid-column-flex::after, .datagrid .datagrid-head .desc.datagrid-row-actions .datagrid-column-flex::after {
        ...
        background-repeat: no-repeat;
        background-size: contain; }
    .datagrid .datagrid-column.asc .datagrid-column-flex::after, .datagrid .datagrid-head .asc.datagrid-row-actions .datagrid-column-flex::after {
    ...
    .datagrid .datagrid-column.desc .datagrid-column-flex::after, .datagrid .datagrid-head .desc.datagrid-row-actions .datagrid-column-flex::after {
    ...
    .datagrid .datagrid-column .datagrid-filter-toggle, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter-toggle {
      ...
      .datagrid .datagrid-column .datagrid-filter-toggle:hover, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter-toggle:hover {
      ...
      .datagrid .datagrid-column .datagrid-filter-toggle.datagrid-filter-open, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter-toggle.datagrid-filter-open {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2016%2016%22%3E%3Cdefs%3E%3Cstyle%3E.cls-1%7Bfill%3A%23007cbb%3Bfill-rule%3Aevenodd%3B%7D%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cpolygon%20class%3D%22cls-1%22%20points%3D%227%209.32%203%205.38%203%205%2013%205%2013%205.38%209%209.32%209%2012.21%207%2013.29%207%209.32%22%2F%3E%3C%2Fsvg%3E"); }
      .datagrid .datagrid-column .datagrid-filter-toggle.datagrid-filtered, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter-toggle.datagrid-filtered {
    ...
    .datagrid .datagrid-column .datagrid-filter, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter {
      ...
      font-weight: normal;
      z-index: 1000; }
      .datagrid .datagrid-column .datagrid-filter .datagrid-filter-close-wrapper, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter .datagrid-filter-close-wrapper {
        text-align: right; }
        .datagrid .datagrid-column .datagrid-filter .datagrid-filter-close-wrapper .close, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter .datagrid-filter-close-wrapper .close {
          float: none; }
      .datagrid .datagrid-column .datagrid-filter .datagrid-filter-apply, .datagrid .datagrid-head .datagrid-row-actions .datagrid-filter .datagrid-filter-apply {
        margin-bottom: 0; }
  ...
  .datagrid .datagrid-select .checkbox label {
    ...
    .datagrid .datagrid-select .radio label::before, .datagrid .datagrid-select .radio label::after,
  ...
  .datagrid .datagrid-foot-select.checkbox {
    ...
    .datagrid .datagrid-foot-select.checkbox label {
      ...
      opacity: 1;
      line-height: inherit; }
    .datagrid .datagrid-foot-select.checkbox input[type="checkbox"] + label::before, .datagrid .datagrid-foot-select.checkbox input[type="checkbox"] + label::after {
      top: 0.333333rem; }
    .datagrid .datagrid-foot-select.checkbox input[type="checkbox"] + label::after {
      border-left-color: #fff;
      border-bottom-color: #fff; }
  .datagrid .datagrid-row-actions {
    padding: 0; }
    .datagrid .datagrid-row-actions clr-icon {
      height: 0.58333rem;
      vertical-align: bottom; }
  .datagrid .datagrid-signpost-trigger .signpost {
    margin: -0.3rem 0;
    height: 1.03rem; }
    .datagrid .datagrid-signpost-trigger .signpost .signpost-trigger {
      height: inherit;
      line-height: 1rem; }
  .datagrid .datagrid-expandable-caret {
    padding: calc(0.125rem - 1px) 0.16667rem 0.125rem;
    text-align: center; }
    .datagrid .datagrid-expandable-caret .datagrid-expandable-caret-button {
      -webkit-appearance: none;
      -moz-appearance: none;
      -ms-appearance: none;
      -o-appearance: none;
      ...
      height: 1.25rem;
      width: 1.25rem; }
    .datagrid .datagrid-expandable-caret .datagrid-expandable-caret-icon {
      color: #737373;
      margin-top: 0.125rem; }
      .datagrid .datagrid-expandable-caret .datagrid-expandable-caret-icon svg {
        transition: transform 0.2s ease-in-out; }
    .datagrid .datagrid-expandable-caret .spinner {
      margin-top: 0.25rem; }
    .datagrid .datagrid-expandable-caret.datagrid-column, .datagrid .datagrid-head .datagrid-expandable-caret.datagrid-row-actions {
      padding: 0.45833rem 0.5rem 0.45833rem; }
  .datagrid .datagrid-body .datagrid-row {
    ...
    .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow {
      ...
      .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow::after {
        ...
        height: 0;
        margin-top: -0.20833rem;
        border-right: 0.20833rem solid #22343c;
        border-top: 0.20833rem solid transparent;
        border-bottom: 0.20833rem solid transparent; }
      .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item {
        ...
        text-align: left;
        width: 100%; }
        .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:hover, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:focus {
          text-decoration: none;
          background-color: #29414e; }
        ...
        .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:focus {
          outline: 0; }
        .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item.disabled, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:disabled {
          cursor: not-allowed;
          opacity: 0.4;
          user-select: none; }
          .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item.disabled:hover, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:disabled:hover {
            background: none; }
          .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item.disabled:active, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item.disabled:focus, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:disabled:active, .datagrid .datagrid-body .datagrid-row .datagrid-action-overflow .action-item:disabled:focus {
            background: none;
            box-shadow: none; }
    ...
    .datagrid .datagrid-body .datagrid-row .datagrid-action-toggle {
      ...
      margin: calc(0.125rem - 1px) 0.16667rem; }
...
.datagrid-foot {
  ...
  .datagrid-foot .pagination {
    display: flex;
    align-items: center; }
    .datagrid-foot .pagination-description {
      white-space: nowrap; }
    .datagrid-foot .pagination-list {
      margin-left: 1.5rem;
      height: calc(1.5rem - 2px); }
  .datagrid-foot .column-switch-wrapper {
    flex: 0 0 auto; }
    .datagrid-foot .column-switch-wrapper.active .column-toggle--action {
      color: #007cbb; }
    .datagrid-foot .column-switch-wrapper .column-toggle--action {
      ...
      padding-right: 0;
      color: #9a9a9a; }
      .datagrid-foot .column-switch-wrapper .column-toggle--action:hover {
        color: #007cbb; }
...
.datagrid-select .radio, .datagrid-select .checkbox {
  margin-top: -0.04167rem; }

.datagrid-compact .datagrid-column .datagrid-column-separator::after, .datagrid-compact .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator::after, .datagrid .datagrid-head .datagrid-compact .datagrid-row-actions .datagrid-column-separator::after {
  height: calc(100% + 0.5 * 0.5rem - 1px);
  top: calc(-0.25 * 0.5rem + 1px); }

.datagrid-compact .datagrid-column .datagrid-column-separator .datagrid-column-handle-tracker, .datagrid-compact .datagrid .datagrid-head .datagrid-row-actions .datagrid-column-separator .datagrid-column-handle-tracker, .datagrid .datagrid-head .datagrid-compact .datagrid-row-actions .datagrid-column-separator .datagrid-column-handle-tracker {
  top: -0.25rem; }
...
.datagrid-compact .datagrid-expandable-caret.datagrid-column, .datagrid-compact .datagrid .datagrid-head .datagrid-expandable-caret.datagrid-row-actions, .datagrid .datagrid-head .datagrid-compact .datagrid-expandable-caret.datagrid-row-actions {
  padding-top: calc(0.20833rem + 1px);
  padding-bottom: calc(0.20833rem); }

.datagrid-compact .datagrid-signpost-trigger .signpost .signpost-trigger clr-icon:not(
[shape="info-circle"]):not(
[shape="exclamation-triangle"]):not(
[shape="exclamation-circle"]):not(
[shape="check-circle"]):not(
[shape="info"]):not(
[shape="error"]) {
  width: 0.875rem;
  height: 0.875rem; }

.datagrid-compact .datagrid-body .datagrid-row .datagrid-action-toggle {
  padding-top: calc(0.20833rem + 1px);
  padding-bottom: calc(0.20833rem);
  margin-top: 0;
  margin-bottom: 0;
  outline-offset: -0.16667rem; }
  .datagrid-compact .datagrid-body .datagrid-row .datagrid-action-toggle clr-icon {
    margin-bottom: 0; }

.datagrid-compact .datagrid-foot {
  height: 1rem;
  padding: 0 0.5rem;
  line-height: calc(1rem - 1px); }
  .datagrid-compact .datagrid-foot .pagination-list {
    height: calc(1rem - 2px); }
  .datagrid-compact .datagrid-foot .column-switch-wrapper .column-toggle--action {
    margin: 0;
    outline-offset: -0.16667rem; }
  .datagrid-compact .datagrid-foot .datagrid-foot-select.checkbox input[type="checkbox"] + label::before, .datagrid-compact .datagrid-foot .datagrid-foot-select.checkbox input[type="checkbox"] + label::after {
    top: 0.11111rem; }
...
.clr-wizard .modal-dialog {
  ...
  justify-content: space-between;
  align-items: center;
  box-shadow: 0 0.04167rem 0.08333rem 0.08333rem rgba(0, 0, 0, 0.2);
  height: 50%;
  max-height: 100%; }
...
.clr-wizard .modal-header {
  flex: 0 0 auto;
  width: 100%;
  padding: 1rem 0.79167rem 0.25rem 1rem;
  display: flex;
...
.clr-wizard .clr-wizard-stepnav-item {
  display: block;
  box-shadow: 0.16667rem 0 0 #3c4950 inset;
  margin: 0 0 -1px 0;
  padding: 0.25rem 0;
  ...
  .clr-wizard .clr-wizard-stepnav-item.complete {
    box-shadow: 0.16667rem 0 0 #60b515 inset;
    transition: box-shadow 0.2s ease-in; }
...
.clr-wizard.wizard-xl .modal-content, .clr-wizard.wizard-xl .clr-wizard-stepnav-wrapper {
  max-height: 75vh; }
...
.clr-wizard--ghosted .modal-dialog, .clr-wizard--ghosted .modal-outer-wrapper {
  width: 26rem; }

.clr-wizard--ghosted .modal-content-wrapper {
  width: 24rem; }

.clr-wizard--ghosted.wizard-md .modal-dialog, .clr-wizard--ghosted.wizard-md .modal-outer-wrapper {
  width: 26rem; }
...
.clr-wizard--ghosted.wizard-lg .modal-dialog, .clr-wizard--ghosted.wizard-lg .modal-outer-wrapper {
  width: 38rem; }
...
.clr-wizard--ghosted.wizard-xl .modal-dialog, .clr-wizard--ghosted.wizard-xl .modal-outer-wrapper {
  width: 50rem; }
...
.signpost-content {
  ...
  .signpost-content.top-left .popover-pointer, .signpost-content.top-middle .popover-pointer, .signpost-content.top-right .popover-pointer {
    ...
    .signpost-content.top-left .popover-pointer:before, .signpost-content.top-middle .popover-pointer:before, .signpost-content.top-right .popover-pointer:before {
      ...
      bottom: 2px; }
  .signpost-content.top-left .signpost-flex-wrap {
    border-bottom-right-radius: 0; }
  ...
  .signpost-content.top-middle .popover-pointer {
    ...
    .signpost-content.top-middle .popover-pointer:before {
      border-right: 0.5rem solid transparent;
      left: 1px; }
  .signpost-content.top-right .signpost-flex-wrap {
    border-bottom-left-radius: 0; }
  ...
  .signpost-content.bottom-left .popover-pointer, .signpost-content.bottom-middle .popover-pointer, .signpost-content.bottom-right .popover-pointer {
    ...
    .signpost-content.bottom-left .popover-pointer:before, .signpost-content.bottom-middle .popover-pointer:before, .signpost-content.bottom-right .popover-pointer:before {
      ...
      top: 2px; }
  .signpost-content.bottom-left .signpost-flex-wrap {
    border-top-right-radius: 0; }
  ...
  .signpost-content.bottom-right .signpost-flex-wrap {
    border-top-left-radius: 0; }
  ...
  .signpost-content.left-top .signpost-flex-wrap {
    border-bottom-right-radius: 0; }
  ...
  .signpost-content.left-bottom .signpost-flex-wrap {
    border-top-right-radius: 0; }
  ...
  .signpost-content.right-top .popover-pointer, .signpost-content.right-middle .popover-pointer, .signpost-content.right-bottom .popover-pointer {
    ...
    .signpost-content.right-top .popover-pointer:before, .signpost-content.right-middle .popover-pointer:before, .signpost-content.right-bottom .popover-pointer:before {
      ...
      left: 2px; }
  .signpost-content.right-top .signpost-flex-wrap {
    border-bottom-left-radius: 0; }
  ...
  .signpost-content.right-middle .popover-pointer {
    ...
    .signpost-content.right-middle .popover-pointer:before {
      border-bottom: 0.5rem solid transparent;
      top: 1px; }
  .signpost-content.right-bottom .signpost-flex-wrap {
    border-top-left-radius: 0; }
